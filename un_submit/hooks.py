...
TransactionBase.validate_with_previous_doc = purchase_receipt_override.transaction_validate_with_previous_doc
...
doc_events = {
    ...
    "Purchase Invoice": {
     ...
     "Sales Order": {
        "before_submit": "un_submit.credit_control.credit_control.validate_credit_block"
    }
}
# Scheduled Tasks
# ---------------
